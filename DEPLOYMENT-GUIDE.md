...
|---------------|----------------------|----------------------|
| **PZERO URL** | `http://pzero-gateway-app:3001/v1` | `https://pm-gateway.projectzero.io/v1` |
...
1. Register at https://pm-gateway.projectzero.io/register
...
- [ ] Use real PZERO Gateway URL (`https://pm-gateway.projectzero.io/v1`)
...
curl https://pm-gateway.projectzero.io/v1/health
...
**Production:**
- Check PZERO Gateway is accessible: `curl https://pm-gateway.projectzero.io/v1/health`
...
- For production: Get real credentials from https://pm-gateway.projectzero.io/register
