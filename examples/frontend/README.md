...
PZERO_API_KEY=your-pzero-api-key
...
- Verify `PZERO_API_KEY` and `PZERO_CLIENT_ID` in backend `.env`
...
- Update `PROMPT_MINER_ADDRESS` with your deployed contract address
...
- [ ] Change `CHAIN_ID` to 7208 (Nexera mainnet)
- [ ] Update `BACKEND_API_URL` to production URL (HTTPS)
- [ ] Update `BLOCK_EXPLORER_URL` to Nexera mainnet explorer
